...
# ==============================================================================
# PROYECTO: OmegaSolver V3.2.2 (Actualizado con MÃ³dulo QoS)
# ARCHIVO: OmegaSolver_V3.2.2.ps1
# DESCRIPCIÃ“N: Herramienta grÃ¡fica de diagnÃ³stico, reparaciÃ³n y optimizaciÃ³n de red.
# ==============================================================================
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="OmegaSolver V3.2.2" Height="640" Width="850"
    ...
    <Grid Margin="15">
        ...
        <StackPanel Grid.Row="0" Margin="0,0,0,15">
            <TextBlock Text="OmegaSolver V3.2.2" FontSize="22" FontWeight="Bold" Foreground="#0078D4"/>
        ...
        <Grid Grid.Row="1">
            ...
            <Border Grid.Column="2" Background="#1E1E1E" CornerRadius="6" Padding="10" Margin="5,0,0,0" BorderBrush="#2D2D2D" BorderThickness="1">
                <StackPanel>
                    <TextBlock Text="ðŸš€ Mantenimiento" FontSize="14" FontWeight="Bold" Margin="4,0,0,10" Foreground="#0078D4"/>
...
function Start-DeepCleaningRoutine {
    ...
    Write-OmegaLog "[+] Vaciando descargas de WinUpdate, logs CBS y cachÃ©s de sistema..."
    ...
    Write-OmegaLog "[+] Ejecutando optimizaciÃ³n del almacÃ©n de componentes (WinSxS)..."
...
# InicializaciÃ³n
Write-OmegaLog "OmegaSolver V3.2.2 iniciado correctamente."
Write-OmegaLog "Esperando acciÃ³n del usuario..."

# Eventos
$btnManual.Add_Click({
    $manualText = "Â¡Bienvenido a OmegaSolver V3.2.2!`n`n" +
                  "ðŸŒ RED Y CONEXIÃ“N:`n" +
                  "- Desbloquear Ancho de Banda QoS: Modifica el registro de Windows para establecer el lÃ­mite de ancho de banda reservable en 0%."
                  
    [System.Windows.MessageBox]::Show($manualText, "Manual Explicativo - OmegaSolver V3.2.2", [System.Windows.MessageBoxButton]::OK, [System.Windows.MessageBoxImage]::Information)
})
