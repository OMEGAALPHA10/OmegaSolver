...
# ==============================================================================
# PROYECTO: OmegaSolver V3.3 (Actualizado con OptimizaciÃ³n de EnergÃ­a)
...
$btnMaxPower.Add_Click({
    ...
    # Habilita el esquema de Alto Rendimiento estÃ¡ndar en Windows (GUID: 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c)
